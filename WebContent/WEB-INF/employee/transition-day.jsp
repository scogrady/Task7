				...
				<tbody>
					<c:forEach var="fund" items="${fundList}">
						<tr>
							...
							<td class="col-md-2"><input type="hidden" name="id"
								value="${fund.fund_id}"> <input type="text" name="price"
								class="form-control" pattern="\d+(\.\d{1,2})?"
			...
			<div class="row">
				...
				<div class="col-md-4">
					<input type="text" class="form-control col-md-2" name="date"
						placeholder="Transition Date" required>
				</div>
