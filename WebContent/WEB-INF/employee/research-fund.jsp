					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail recommandationSection">
							<div class="caption">
								...
								<p>
									<a href="EmployeeResearchFund.do?fund_id=${recommandFund.getFund_id()}"
										class="btn btn-primary" role="button">View More</a> <a
										href="EmployeeResearchFund.do?fund_id=${now_id}&compare_id=${recommandFund.getFund_id()}" class="btn btn-default" role="button">Compare</a>
								</p>
							</div>
						</div>
					</div>
