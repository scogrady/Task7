...
public class FundPriceHistoryDAO extends GenericDAO<FundPriceHistoryBean> {
	...
	public FundPriceHistoryBean[] readByFundID(int fund_id) throws RollbackException {
		FundPriceHistoryBean[] fundList = match(MatchArg.equals("fund_id", fund_id));
		return fundList;
	}
	
	public FundPriceHistoryBean[] readByDate(Date price_date) throws RollbackException {
		FundPriceHistoryBean[] fundList = match(MatchArg.equals("price_date", price_date));
		return fundList;
	}
